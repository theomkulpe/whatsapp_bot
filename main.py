from utils import open_whatsapp_web, click_search_button, clear_search_box, go_to_home_page, search_chat, check_unread_messages, open_chat, extract_messages_with_mention, generate_responses_for_new_messages, send_approval_requests, conscious_conversations, send_approved_responses
import time
...
if __name__ == "__main__":
    ...
    if new_messages or user_unread_count:
        ...
        # print(messages_and_approved_responses)
